...
const CONFIG_URL = "https://raw.githubusercontent.com/antor-hossain/HOSSAIN-API/refs/heads/main/HOSSAIN-API.json";
...
module.exports.run = async function ({ api, event }) {
  ...
  try {
    ...
    if (!quizAPI) return api.sendMessage("Quiz API error call boss HOSSAIN✔️", threadID, messageID);
    ...
    api.sendMessage("Quiz API error call boss HOSSAIN✔", threadID, messageID);
  }
};
