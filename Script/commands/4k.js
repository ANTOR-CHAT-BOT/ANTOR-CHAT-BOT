...
module.exports = {
  config: {
    ...
    version: "1.0.0",
    hasPermssion: 0,
    credits: "ANTOR HOSSAIN", //don't change credit
...
async function processImage(api, threadID, messageID, messageReply) {
  ...
  try {
    const configUrl =
      "https://raw.githubusercontent.com/antor-hossain/HOSSAIN-API/refs/heads/main/HOSSAIN-API.json";
    ...
    api.sendMessage("❌ API Error! Boss HOSSAIN ke message din!", threadID, messageID);
  }
}
