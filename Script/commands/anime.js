module.exports.config = {
  ...
  description: "Random Anime Videos From HOSSAIN API",
...
module.exports.run = async function ({ api, event }) {
  ...
  const API_LIST_URL = "https://raw.githubusercontent.com/antor-hossain/HOSSAIN-API/refs/heads/main/HOSSAIN-API.json";
  try {
    ...
    writer.on("finish", () => {
      api.sendMessage(
        {
          body: "🎬 HOSSAIN Anemi Random Video",
